...
class Story {
  ...
  //One by one compiling the 8 arrays of story data that was preset and created for the interface:
  //as shown by the example above for class Story
...
class StoryList {
  ...
  static async getStories() {
    ...
    const response = await axios({       //requesting information from 8 preset stories/user information
